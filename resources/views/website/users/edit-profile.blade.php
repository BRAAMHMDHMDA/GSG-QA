            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="hero-btn-box text-right py-3">
                        <a href="{{route('user.show',Auth::id())}}" class="btn theme-btn theme-btn-outline theme-btn-outline-gray"><i class="la la-user mr-1"></i>View Profile</a>
                    </div>
                </div><!-- end col-lg-4 -->
            </div><!-- end row -->
                        ...
                        <div class="tab-pane fade show active" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                            <div class="user-panel-main-bar">
                                <div class="user-panel">
                                    ...
                                    <form method="post" class="pt-35px" action="{{ route('user.update',Auth::id()) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                            ...
                                            <div class="row pt-4 align-items-center">
                                                <div class="col-lg-6">
                                                    <div class="edit-profile-photo d-flex flex-wrap align-items-center">
                                                        <img src="{{ $user->full_image_path }}" alt="user avatar" class="profile-img mr-4">
                                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-box col-6">
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control form--control" type="text" name="first_name" required value="{{ $user->first_name }}">
                                                            </div>
                                                        </div>
                                                        <div class="input-box col-6">
                                                            <label class="fs-13 text-black lh-20 fw-medium">Last name</label>
                                                            <div class="form-group">
                                                                <input class="form-control form--control" type="text" name="last_name" required value="{{ $user->last_name }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea class="form-control form--control user-text-editor" rows="10" cols="40" name="about_me">{{ $user->about_me }}</textarea>
                                                        </div>
                                                    </div>
                                                </div><!-- end col-lg-12 -->
                                            </div><!-- end row -->
                                            ...
                                            <div class="row pt-4">
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control form--control pl-40px" type="url" name="website_link" value="{{ $user->website_link }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control form--control pl-40px" type="url" name="github_link">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control form--control pl-40px" type="url" name="twitter_link" value="{{ $user->twitter_link }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control form--control pl-40px" type="url" name="facebook_link" value="{{ $user->facebook_link }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control form--control pl-40px" type="url" name="instagram_link" value="{{ $user->instagram_link }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control form--control pl-40px" type="url" name="youtube_link" value="{{ $user->youtube_link }}">
                        ...
                        <div class="tab-pane fade" id="privacy" role="tabpanel" aria-labelledby="privacy-tab">
                            <div class="user-panel-main-bar">
                                <div class="user-panel">
                                    ...
                                    <form method="post" action="{{ route('user.update',Auth::id()) }}" enctype="multipart/form-data" class="pt-20px">
                                        @csrf
                                        <div class="settings-item">
                                            <div class="input-box">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row no-gutters text-center">
                                    ...
                                    <div class="col-lg-12 pt-3">
                                        <p class="fs-14">To get answer of question <a href="../Auth/signup.blade.php" class="text-color hover-underline">Join<i class="la la-arrow-right ml-1"></i></a></p>
                                    </div>
                                </div><!-- end row -->
                            </div>
                        </div><!-- end card -->
                                ...
                                <div class="sidebar-questions pt-3">
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="../questions/show.blade.php">Using web3 to call precompile contract</a></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="../questions/show.blade.php">Is it true while finding Time Complexity of the algorithm [closed]</a></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="../questions/show.blade.php">image picker and store them into firebase with flutter</a></h5>
                                            <small class="meta">
