            ...
            <div class="row">
                    ...
                    <div class="hero-content">
                        <div class="media media-card align-items-center shadow-none p-0 mb-0 rounded-0 bg-transparent">
                            <div class="media-img media--img">
                                <img src="{{$user->full_image_path}}" alt="avatar">
                            </div>
                            <div class="media-body">
                                <h5>{{ $user->full_name }}</h5>
                                <small class="meta d-block lh-20 pb-2">
                                    <span>{{$user->address}}, member since {{$user->created_at->diffForHumans()}}</span>
                                </small>
                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs generic-tabs generic--tabs generic--tabs-2 mt-4" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="user-activity-tab" data-toggle="tab" href="#user-activity"
                               role="tab" aria-controls="user-activity" aria-selected="false">Activity</a>
                        </li>
                    </ul>
                </div><!-- end col-lg-4 -->
            </div><!-- end row -->
                        ...
                        <div class="tab-pane fade show active" id="user-profile" role="tabpanel"
                            ...
                            <div class="user-panel-main-bar">
                                <div class="user-panel mb-30px">
                                    <p class="pb-2">{!! $user->about_me !!}</p>
                                </div><!-- end user-panel -->
                                <div class="user-panel mb-30px pt-30px border-top border-top-gray">
                                    <ul class="generic-list-item generic-list-item-hover-underline">
                                        @if($user->website_link)
                                            <li class="pl-3"><a href="{{$user->website_link}}" class="d-inline-block"><i class="la la-link"></i> My
                                                    Website</a></li>
                                        @endif
                                        @if($user->github_link)
                                            <li class="pl-3"><a href="{{$user->github_link}}" class="d-inline-block"><i class="la la-github"></i> My
                                                    GitHub</a></li>
                                        @endif
                                        @if($user->facebook_link)

                                                <li class="pl-3"><a href="{{$user->facebook_link}}" class="d-inline-block"><i class="la  la-facebook-f"></i> My Facebook</a></li>
                                        @endif
                                        @if($user->twitter_link)
                                            <li class="pl-3"><a href="{{$user->twitter_link}}" class="d-inline-block"><i class="la la-twitter"></i>
                                                        My Twitter</a></li>
                                        @endif
                                        @if($user->instagram_link)
                                            <li class="pl-3"><a href="{{$user->instagram_link}}" class="d-inline-block"><i class="la la-instagram"></i> My
                                                    Instagram</a></li>
                                        @endif
                                        @if($user->youtube_link)
                                            <li class="pl-3"><a href="{{$user->youtube_link}}" class="d-inline-block"><i class="la la-youtube-play"></i> My
                                                    YouTube</a></li>
                                        @endif
                                    </ul>
                                </div><!-- end user-panel -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 responsive-column-half">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fw-medium">{{$user->answers->count()}}</h5>
                                        ...
                                        <div class="col-lg-4 responsive-column-half">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fw-medium">{{$user->questions->count()}}</h5>
                                ...
                                <div class="user-panel mb-30px">
                                    ...
                                    <div class="vertical-list">
                                        ...
                                        <div class="view-more pt-3 px-3">
                                            <a href="#" class="btn-text fs-15">View all tags <i
                                    ...
                                    <div class="vertical-list">
                                        <div class="item p-0">
                                            <div
                                                ...
                                                <div class="votes py-2 answered-accepted">
                                                    <div
                                                        class="vote-block d-flex align-items-center justify-content-between"
                                                        title="Votes">
                                                        <span class="vote-counts">6475</span>
                                                        <span class="vote-icon"></span>
                                                    </div>
                                                    <div
                                                        class="answer-block d-flex align-items-center justify-content-between"
                                                        title="Answers">
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="../questions/show.blade.php">How to make Git “forget”
                                                            about a file that was tracked but is now in .gitignore?</a>
                                                    </h5>
                                                    <small class="meta">
                                                        <span>May 12 '20</span>
                                                    </small>
                                        ...
                                        <div class="item p-0">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="../questions/show.blade.php">Undoing a git rebase</a>
                                                    </h5>
                                                    <small class="meta">
                                                        <span>May 12 '20</span>
                                                    </small>
                                        ...
                                        <div class="item p-0">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="../questions/show.blade.php">Difference between “git add
                                                            -A” and “git add .”</a></h5>
                                                    <small class="meta">
                                                        <span>May 12 '20</span>
                                                    </small>
                                        ...
                                        <div class="item p-0">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="../questions/show.blade.php">How to find and restore a
                                                            deleted file in a Git repository</a></h5>
                                                    <small class="meta">
                                                        <span>May 12 '20</span>
                                                    </small>
                                                </div>
                                        ...
                                        <div class="item p-0">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="../questions/show.blade.php">How to undo “git commit
                                                            --amend” done instead of “git commit”</a></h5>
                                                    <small class="meta">
                                                        <span>May 12 '20</span>
                                                    </small>
                                                </div>
                                        ...
                                        <div class="item p-0">
                                            <div
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="../questions/show.blade.php">Branch from a previous
                                                            commit using Git</a></h5>
                                                    <small class="meta">
                                                        <span>May 12 '20</span>
                                                    </small>
                                                </div>
                                        ...
                                        <div class="view-more pt-3 px-3">
                                            <a href="#" class="btn-text fs-15">View all questions and answers <i
                                                    class="la la-arrow-right icon ml-1"></i></a>
                                        </div>
                                    </div><!-- end vertical-list -->
                                </div><!-- end user-panel -->
                                    ...
                                    <div class="badge-top-list">
                                        <div class="badge-top badge-top-gold">
                                            ...
                                            <div class="badge-top-details flex-grow-1">
                                                <div class="vertical-list">
                                                    <div class="item tags">
                                                        <a href="#" class="badge badge-md badge-gray"><span
                                                                class="ball gold"></span> git</a>
                                                        <span class="fs-12 pl-1 font-italic">Jul 29 '10</span>
                                                    </div><!-- end item -->
                                                    <div class="item tags">
                                                        <a href="#" class="badge badge-md badge-gray"><span
                                                                class="ball gold"></span> c#</a>
                                                        <span class="fs-12 pl-1 font-italic">Feb 28 '11</span>
                                                    </div><!-- end item -->
                                                    <div class="item tags border-bottom-0">
                                                        <a href="#" class="badge badge-md badge-dark"><span
                                                                class="ball gold"></span> Legendary</a>
                                        ...
                                        <div class="view-more pt-3 px-3">
                                            <a href="#" class="btn-text fs-15">View all badges <i
                                                    class="la la-arrow-right icon ml-1"></i></a>
                                        </div>
                                    </div><!-- end vertical-list -->
                                </div><!-- end user-panel -->
                        ...
                        <div class="tab-pane fade" id="user-activity" role="tabpanel"
                            ...
                            <div class="user-panel-main-bar">
                                <div class="user-panel mb-40px">
                                    ...
                                    <div
                                        class="media media-card align-items-center shadow-none border border-gray p-3 text-center">
                                        <div class="media-body">
                                ...
                                <div class="user-panel mb-40px">
                                    ...
                                    <div class="badge-stats d-flex align-items-center mb-4 text-center">
                                        <div class="stat flex-grow-1">
                                            <span class="badge d-block mr-2 badge-md badge-gold" title="Gold"><span
                                                    class="ball gold"></span> 91</span>
                                        </div>
                                        <div class="stat flex-grow-1">
                                    ...
                                    <div class="user-stats d-flex align-items-center">
                                        ...
                                        <div class="stat flex-grow-1">
                                            ...
                                            <div class="progress progress-fat">
                                                <div class="progress-bar bg-gray-2" role="progressbar"
                                                     style="width: 90%" aria-valuenow="90" aria-valuemin="0"
                                                     aria-valuemax="100"><span class="text-black">Deputy</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- end user-panel -->
                                ...
                                <div class="user-panel mb-40px">
                                    ...
                                    <div class="summary-panel">
                                        <div
                                            class="border-bottom border-bottom-gray p-3 d-flex align-items-center justify-content-between">
                                            <h4 class="fs-15 fw-regular">Answers <span>(1,979)</span></h4>
                                            <div
                                                class="filter-option-box flex-grow-1 d-flex align-items-center justify-content-end lh-1">
                                        ...
                                        <div class="vertical-list">
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">How to
                                                                make Git “forget” about a file that was tracked but is
                                                                now in .gitignore?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">Undoing a
                                                                git rebase</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">Difference
                                                                between “git add -A” and “git add .”</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">How to
                                                                find and restore a deleted file in a Git repository</a>
                                                        </h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">Branch
                                                                from a previous commit using Git</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                        ...
                                        <div class="vertical-list">
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">What are
                                                                the correct version numbers for C#?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">Curious
                                            ...
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">What's
                                                                your most controversial programming opinion?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">Performance
                                                                surprise with “as” and nullable types</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">What's
                                                                the strangest corner case you've seen in C# or .NET?
                                                                [closed]</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                    ...
                                    <div class="summary-panel">
                                        <div class="vertical-list">
                                            <div class="item tags d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                       class="tag-link tag-link-md tag-link-blue mb-0 lh-20">c#</a>
                                                </div>
                                ...
                                <div class="user-panel mb-40px">
                                    ...
                                    <div class="summary-panel">
                                        <div class="vertical-list">
                                            <div class="item">
                                                <a href="#"
                                                   class="badge badge-md badge-dark d-inline-flex align-items-center mr-1"><span
                                                        class="ball silver"></span> Good Answer</a>
                                    ...
                                    <div class="summary-panel">
                                        <div class="vertical-list">
                                            <div class="item post p-0">
                                                <div
                                                    class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                    <svg aria-hidden="true" class="svg-icon ml-3 icon-question"
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">git: undo
                                                                all working dir changes including new files</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                    <svg aria-hidden="true" class="svg-icon ml-3 icon-answer" width="18"
                                                         height="18" viewBox="0 0 18 18">
                                                        <path fill="#7d848c"
                                                              d="M14 14H3a2 2 0 01-2-2V3c0-1.1.9-2 2-2h12a2 2 0 012 2v14l-3-3zm-1.02-3L9.82 3H8.14l-3.06 8h1.68l.65-1.79h3.15l.69 1.79h1.73zm-2.93-3.12H7.9l1.06-2.92 1.09 2.92z"></path>
                                                    </svg>
                                                    <div class="votes">
                                                        <div class="vote-block" title="Votes">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">How to
                                                                revert uncommitted changes including files and
                                                                folders?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">Detected
                                                                package downgrade warning (dotnet core, vs 2017)</a>
                                                        </h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">What is
                                                                the difference between a variable, object, and
                                                                reference? [duplicate]</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            <div class="item post p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="fs-15"><a href="../questions/show.blade.php">I've
                                                                found a bug in the JIT/CLR - now how do I debug or
                                                                reproduce it?</a></h5>
                                                    </div>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                        ...
                                        <div class="vertical-list">
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5><a href="../questions/show.blade.php"
                                                               class="d-flex align-items-center"><span
                                                                    class="badge bg-12 mr-2 text-white">+100</span> How
                                                                to make Git “forget” about a file that was tracked but
                                                                is now in .gitignore?</a></h5>
                                                        <small class="meta">
                                            ...
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5><a href="../questions/show.blade.php"
                                                               class="d-flex align-items-center"><span
                                                                    class="badge bg-12 mr-2 text-white">+500</span>
                                                                Catching errors being thrown within module</a></h5>
                                                        <small class="meta">
                                            ...
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5><a href="../questions/show.blade.php"
                                                               class="d-flex align-items-center"><span
                                                                    class="badge bg-12 mr-2 text-white">+200</span>
                                                                Alien Dictionary Python</a></h5>
                                                        <small class="meta">
                                            ...
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5><a href="../questions/show.blade.php"
                                                               class="d-flex align-items-center"><span
                                                                    class="badge bg-12 mr-2 text-white">+50</span> How
                                                                to parse JS code into one-operation-per-line with fewest
                                                                temp variables?</a></h5>
                                                        <small class="meta">
                                            ...
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <div class="media-body">
                                                        <h5><a href="../questions/show.blade.php"
                                                               class="d-flex align-items-center"><span
                                                                    class="badge bg-12 mr-2 text-white">+50</span> vue 3
                                                                Server Side Rendering with Vuex and Router</a></h5>
                                                        <small class="meta">
                                                            <span class="pr-1">May 12 '20</span>
                                                            <a href="#" class="author">edublog</a>
                                                        </small>
                                ...
                                <div class="user-panel mb-40px">
                                    ...
                                    <div class="summary-panel">
                                        <div class="vertical-list">
                                            <div class="item">
                                                <p class="fs-14">Of the votes cast, <span
                                                        class="text-black">18,808</span> were upvotes and <span
                                                        class="text-black">42</span> were downvotes. <span
                                                        class="text-black">Arden Smith</span> voted on questions <span
                                                        class="text-black">7,553</span> times and <span
                                                        class="text-black">11,297</span> times on answers.</p>
                                            </div><!-- end item -->
                                            <div class="item">
                                                <p class="fs-14"><span class="text-black">50</span> votes in the last
                                                    month</p>
                                            </div><!-- end item -->
                                            <div class="item">
                                                <p class="fs-14"><span class="text-black">62</span> votes in the last
                                                    week</p>
                                            </div><!-- end item -->
                                            <div class="item">
                                                <p class="fs-14"><span class="text-black">1</span> vote in the last day
                                                </p>
                                            </div><!-- end item -->
                                        </div>
                                    </div><!-- end summary-panel -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="sidebar-questions pt-3">
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="../questions/show.blade.php">Using web3 to call precompile
                                                    contract</a></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="../questions/show.blade.php">Is it true while finding Time
                                                    Complexity of the algorithm [closed]</a></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="../questions/show.blade.php">image picker and store them into
