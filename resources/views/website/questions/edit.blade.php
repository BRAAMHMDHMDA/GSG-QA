...
@section('content')
    ...
    <section class="question-area pt-80px pb-40px" style="background: ghostwhite">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card card-item">
                        <form method="post" action="{{ route('qusetions.update',$question->id) }}" class="card-body">
                            @csrf
                            @method('put')
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="title" placeholder="Question Title" value="{{$question->title}}">
                                </div>
                            </div>
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form--control user-text-editor" rows="10" cols="40" name="body">{{ $question->body }}</textarea>
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <select class="js-example-basic-multiple" id="tags" name="tags[]" multiple style="width: 70%">
                                        @foreach($tags as $tag)
                            ...
                            <div class="settings-item mb-20px border-bottom border-bottom-gray pb-20px">
                                <div class="input-box">
                                    <label class="fs-14 text-black lh-20 fw-medium mb-0">Status</label>
                                    <div class="form-group">
                                        <div class="btn-group btn--group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn active">
                                                <input type="radio" name="status" value="draft" id="option3" @if($question->status=='draft') checked @endif> Draft
                                            </label>
                                            <label class="btn">
                                                <input type="radio" name="status" value="active" id="option4" @if($question->status=='active') checked @endif> Publish
                                            </label>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
         var tags = @php echo json_encode($tagsID); @endphp;
          $('#tags').val(tags);
    </script>
@endpush
