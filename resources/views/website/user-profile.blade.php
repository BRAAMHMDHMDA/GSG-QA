...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/user-profile.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jul 2021 10:18:21 GMT -->
<head>
...
<header class="header-area bg-white border-bottom border-bottom-gray">
                        ...
                        <ul>
                            ...
                            <li class="is-mega-menu">
                                ...
                                <div class="dropdown-menu-item mega-menu">
                                    <ul class="row">
                                        <li class="col-lg-3">
                                            <a href="user-profile.blade.php">user profile</a>
                                            <a href="notifications.html">Notifications</a>
                                            <a href="referrals.html">Referrals</a>
                                            <a href="setting.html">settings</a>
                                            <a href="ask-question.blade.php">ask question</a>
                                            <a href="question-details.blade.php">question details</a>
                                        ...
                                        <li class="col-lg-3">
                                            ...
                                            <a href="signup.blade.php">sign up</a>
                                            <a href="signup-2.html">sign up 2</a>
                                            <a href="recover-password.html">recover password</a>
                                            <a href="home.blade.php">questions layout 2 <span class="badge bg-warning text-white">New</span></a>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled">
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-90px">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="ask-question.blade.php">ask question</a></li>
                    <li><a href="question-details.blade.php">question details</a></li>
        ...
        <div class="off-canvas-btn-box px-4 pt-5 text-center">
            <a href="login.blade.php" class="btn theme-btn theme-btn-sm theme-btn-outline"><i class="la la-sign-in mr-1"></i> Login</a>
            <span class="fs-15 fw-medium d-inline-block mx-2">Or</span>
            <a href="signup.blade.php" class="btn theme-btn theme-btn-sm"><i class="la la-plus mr-1"></i> Sign up</a>
        </div>
                                ...
                                <div class="vertical-list">
                                    <div class="item p-0">
                                        <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="question-details.blade.php">How to make Git “forget” about a file that was tracked but is now in .gitignore?</a></h5>
                                                <small class="meta">
                                                    <span>May 12 '20</span>
                                                </small>
                                            </div>
                                    ...
                                    <div class="item p-0">
                                        <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="question-details.blade.php">Undoing a git rebase</a></h5>
                                                <small class="meta">
                                                    <span>May 12 '20</span>
                                                </small>
                                            </div>
                                    ...
                                    <div class="item p-0">
                                        <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="question-details.blade.php">Difference between “git add -A” and “git add .”</a></h5>
                                                <small class="meta">
                                                    <span>May 12 '20</span>
                                                </small>
                                            </div>
                                    ...
                                    <div class="item p-0">
                                        <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="question-details.blade.php">How to find and restore a deleted file in a Git repository</a></h5>
                                                <small class="meta">
                                                    <span>May 12 '20</span>
                                                </small>
                                            </div>
                                    ...
                                    <div class="item p-0">
                                        <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="question-details.blade.php">How to undo “git commit --amend” done instead of “git commit”</a></h5>
                                                <small class="meta">
                                                    <span>May 12 '20</span>
                                                </small>
                                            </div>
                                    ...
                                    <div class="item p-0">
                                        <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                            ...
                                            <div class="media-body">
                                                <h5><a href="question-details.blade.php">Branch from a previous commit using Git</a></h5>
                                                <small class="meta">
                                                    <span>May 12 '20</span>
                                                </small>
                                            </div>
                                    ...
                                    <div class="vertical-list">
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">How to make Git “forget” about a file that was tracked but is now in .gitignore?</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">Undoing a git rebase</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">Difference between “git add -A” and “git add .”</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">How to find and restore a deleted file in a Git repository</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">Branch from a previous commit using Git</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                    ...
                                    <div class="vertical-list">
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">What are the correct version numbers for C#?</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">Curious null-coalescing operator custom implicit conversion behaviour</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">What's your most controversial programming opinion?</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">Performance surprise with “as” and nullable types</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">What's the strangest corner case you've seen in C# or .NET? [closed]</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="pager pt-30px">
                                    ...
                                    <div class="vertical-list">
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">git: undo all working dir changes including new files</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">How to revert uncommitted changes including files and folders?</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">Detected package downgrade warning (dotnet core, vs 2017)</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">What is the difference between a variable, object, and reference? [duplicate]</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="item post p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="fs-15"><a href="question-details.blade.php">I've found a bug in the JIT/CLR - now how do I debug or reproduce it?</a></h5>
                                                </div>
                                            </div><!-- end media -->
                                        </div><!-- end item -->
                                        <div class="pager pt-30px">
                                    ...
                                    <div class="vertical-list">
                                        <div class="item p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="question-details.blade.php" class="d-flex align-items-center"><span class="badge bg-12 mr-2 text-white">+100</span> How to make Git “forget” about a file that was tracked but is now in .gitignore?</a></h5>
                                                    <small class="meta">
                                        ...
                                        <div class="item p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="question-details.blade.php" class="d-flex align-items-center"><span class="badge bg-12 mr-2 text-white">+500</span> Catching errors being thrown within module</a></h5>
                                                    <small class="meta">
                                        ...
                                        <div class="item p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="question-details.blade.php" class="d-flex align-items-center"><span class="badge bg-12 mr-2 text-white">+200</span> Alien Dictionary Python</a></h5>
                                                    <small class="meta">
                                        ...
                                        <div class="item p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="question-details.blade.php" class="d-flex align-items-center"><span class="badge bg-12 mr-2 text-white">+50</span> How to parse JS code into one-operation-per-line with fewest temp variables?</a></h5>
                                                    <small class="meta">
                                        ...
                                        <div class="item p-0">
                                            <div class="media media-card media--card align-items-center shadow-none rounded-0 mb-0 bg-transparent">
                                                ...
                                                <div class="media-body">
                                                    <h5><a href="question-details.blade.php" class="d-flex align-items-center"><span class="badge bg-12 mr-2 text-white">+50</span> vue 3 Server Side Rendering with Vuex and Router</a></h5>
                                                    <small class="meta">
                                                        <span class="pr-1">May 12 '20</span>
                                                        <a href="#" class="author">edublog</a>
                                                    </small>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row no-gutters text-center">
                                ...
                                <div class="col-lg-12 pt-3">
                                    <p class="fs-14">To get answer of question <a href="signup.blade.php" class="text-color hover-underline">Join<i class="la la-arrow-right ml-1"></i></a></p>
                                </div>
                            </div><!-- end row -->
                        </div>
                    </div><!-- end card -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="sidebar-questions pt-3">
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><a href="question-details.blade.php">Using web3 to call precompile contract</a></h5>
                                        <small class="meta">
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><a href="question-details.blade.php">Is it true while finding Time Complexity of the algorithm [closed]</a></h5>
                                        <small class="meta">
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><a href="question-details.blade.php">image picker and store them into firebase with flutter</a></h5>
                                        <small class="meta">
                                            <span class="pr-1">1 hour ago</span>
                                            <span class="pr-1">. by</span>
...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/user-profile.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jul 2021 10:18:22 GMT -->
</html>
