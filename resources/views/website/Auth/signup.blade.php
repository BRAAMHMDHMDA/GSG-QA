@extends('website.layouts.layouts-auth')

@section('title','Sign up')

@section('content')
    <section class="sign-up-area pt-80px pb-80px position-relative" style="background: #e4e4fa;">
        <div class="container">
            <!-- Validation Errors -->
                ...
                <div class="card-body row p-0">
                    <div class="col-lg-6">
                        <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                            <img src="{{ asset('website_assets/images/undraw-remotely.svg') }}" alt="Image" class="img-fluid">
                        </div>
                    </div><!-- end col-lg-6 -->
                        ...
                        <div class="form-action-wrapper py-5">
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="first_name" class="form-control form--control @error('first_name') is-invalid @enderror" placeholder="Enter First name" value='{{ old('first_name') }}' required>
                                    @error('first_name')
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="last_name" class="form-control form--control @error('last_name') is-invalid @enderror" placeholder="Enter Last name" value="{{ old('last_name') }}" required>
                                    @error('last_name')
                                      <p class="invalid-feedback">{{ $message }}<p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control form--control @error('email') is-invalid @enderror" placeholder="Email address" value="{{ old('email') }}" required>
                                @error('email')
                                <p class='invalid-feedback'> {{ $message }} </p>
                                @enderror
                            </div>
...
{{--                                <p class="fs-13 lh-18">Passwords must contain at least eight characters, including at least 1 letter and 1 number.</p>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-1">
                                    <input class="form-control form--control password-field" type="password" name="password_confirmation" placeholder="Password Confirmation" required>
                                </div>
                            </div>
                            <!-- end form-group -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button id="send-message-btn" class="btn theme-btn w-100 g-recaptcha" data-sitekey="reCAPTCHA_site_key" data-callback='onSubmit' data-action='submit' type="submit">Sign up <i class="la la-arrow-right icon ml-1"></i></button>
                            </div><!-- end form-group -->
