...
@section('content')
    <section class="login-area pt-80px pb-80px position-relative" style="background: #e4e4fa;">
                ...
                <div class="card-body row p-0">
                    ...
                    <div class="col-lg-5 mx-auto">
                        <div class="form-action-wrapper py-5">
                            ...
                            <div class="form-group">
                                <label for="email" class="fs-14 text-black fw-medium lh-18">Email</label>
                                <input type="email" id="email" name="email" class="form-control form--control @error('email') is-invalid @enderror" placeholder="Email address" value="{{ old('email') }}" required>
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control form--control password-field @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password"  type="password" required autocomplete="current-password">
                                    @error('password')
                                    <p class="invalid-feedback">{{ $message }}<p>
                                    @enderror
