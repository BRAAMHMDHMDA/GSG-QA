            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card card-item">
                        <form method="post" action="{{ route('qusetions.store') }}" class="card-body">
                            @csrf
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="title" placeholder="Question Title">
                                </div>
                            </div><!-- end input-box -->
{{--                            <div class="input-box">--}}
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form--control user-text-editor" rows="10" cols="40" name="body"></textarea>
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="input-tags input--tags" type="text" name="tags" placeholder="e.g. php">
                                </div>
                            </div><!-- end input-box -->
{{--                            <div class="input-box">--}}
...
{{--                            </div><!-- end input-box -->--}}
                                    ...
                                    <div class="form-group">
                                        <div class="btn-group btn--group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn active">
                                                <input type="radio" name="status" value="draft" id="option3" checked> Draft
                                            </label>
                                            <label class="btn">
                                                <input type="radio" name="status" value="active" id="option4"> Publish
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="input-box pt-2">
                                ...
                                <div class="btn-box">
                                    <button type="submit" class="btn btn-info">Publish your question</button>
                                </div>
                            </div>
                        </form>
                    </div><!-- end card -->
