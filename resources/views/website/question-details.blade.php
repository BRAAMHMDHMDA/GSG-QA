                        ...
                        <div class="question-highlight">
                            <div class="media media-card shadow-none rounded-0 mb-0 bg-transparent p-0">
                                <div class="media-body">
                                    <h5 class="fs-20"><a href="question-details.blade.php">{{ $question->title }}</a></h5>
                                ...
                                <div class="question-post-user-action">
                                    ...
                                    <div class="media media-card user-media owner align-items-center">
                                        ...
                                        <div class="media-body d-flex flex-wrap align-items-center justify-content-between">
                                            <div>
                                                <h5 class="pb-1"><a href="user-profile.blade.php">{{$question->user->name}}</a></h5>
                                ...
                                <div class="comments-wrap">
                                    <ul class="comments-list">
                                        <li>
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <a href="user-profile.blade.php" class="comment-user" title="15,467 reputation">Majed Badawi</a>
                                                <span class="comment-separated">-</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <span class="comment-separated">-</span>
                                                <a href="user-profile.blade.php" class="comment-user owner" title="224,110 reputation">Arden Smith</a>
                                                <span class="comment-separated">-</span>
                                                <a href="#" class="comment-date">8 hours ago</a>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <div class="comment-body">
                                                <span class="comment-copy">Your are missing quotes <code class="code">data-productId=7</code> Your markup breaks after that</span>
                                                <span class="comment-separated">-</span>
                                                <a href="user-profile.blade.php" class="comment-user" title="6,514 reputation">Kevin Martin</a>
                                                <span class="comment-separated">-</span>
                                                <a href="#" class="comment-date">8 hours ago</a>
                                            </div>
                                        </li>
                                    ...
                                    <div class="comment-form">
                                        ...
                                        <div class="collapse border-top border-top-gray mt-2 pt-3" id="addCommentCollapse">
                                            <form method="post" action="{{route('comments.store')}}" class="row pb-3">
                                                <div class="col-lg-12">
                                ...
                                <div class="question-post-user-action">
                                    ...
                                    <div class="media media-card user-media align-items-center">
                                        ...
                                        <div class="media-body d-flex align-items-center justify-content-between">
                                            <div>
                                                <h5 class="pb-1"><a href="user-profile.blade.php">Majed Badawi</a></h5>
                                                <div class="stats fs-12 d-flex align-items-center lh-18">
                            ...
                            <div class="card-body">
                                ...
                                <div class="sidebar-questions pt-3">
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="question-details.blade.php">How to select the dom element with event.target</a></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="question-details.blade.php">How can you cut an onion without crying?</a></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card media--card-2">
                                        <div class="media-body">
                                            <h5><a href="question-details.blade.php">How to change the behavior of dropdown buttons in HTML</a></h5>
                                            <small class="meta">
